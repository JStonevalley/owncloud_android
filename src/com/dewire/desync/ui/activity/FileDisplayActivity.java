...
package com.dewire.desync.ui.activity;
...
import com.dewire.desync.operations.RemoveFileOperation;
import com.dewire.desync.operations.RenameFileOperation;
import com.dewire.desync.operations.SynchronizeFileOperation;
import com.dewire.desync.operations.UnshareLinkOperation;
import com.dewire.desync.services.observer.FileObserverService;
import com.dewire.desync.syncadapter.FileSyncAdapter;
import com.dewire.desync.ui.dialog.ConfirmationDialogFragment;
import com.dewire.desync.ui.dialog.CreateFolderDialogFragment;
import com.dewire.desync.ui.dialog.SslUntrustedCertDialog;
import com.dewire.desync.ui.dialog.SslUntrustedCertDialog.OnSslUntrustedCertListener;
import com.dewire.desync.ui.dialog.UploadSourceDialogFragment;
import com.dewire.desync.ui.fragment.FileDetailFragment;
import com.dewire.desync.ui.fragment.FileFragment;
import com.dewire.desync.ui.fragment.OCFileListFragment;
import com.dewire.desync.ui.preview.PreviewImageActivity;
import com.dewire.desync.ui.preview.PreviewImageFragment;
import com.dewire.desync.ui.preview.PreviewMediaFragment;
import com.dewire.desync.ui.preview.PreviewVideoActivity;
import com.dewire.desync.utils.DisplayUtils;
import com.dewire.desync.utils.ErrorMessageAdapter;
import com.dewire.desync.utils.FileStorageUtils;
import com.dewire.desync.utils.UriUtils;
...
public class FileDisplayActivity extends HookActivity
    ...
    public static final String ACTION_DETAILS = "com.dewire.desync.ui.activity.action.DETAILS";
    ...
    public void onBackPressed() {
        ...
        if (listOfFiles != null) {  // should never be null, indeed
            ...
            showUploadNewFolderBtns();
        }
        cleanSecondFragment();

    }

    public void hideUploadNewFolderBtns() {
        if (!((getResources().getConfiguration().screenLayout &
                getResources().getConfiguration().SCREENLAYOUT_SIZE_MASK) ==
                getResources().getConfiguration().SCREENLAYOUT_SIZE_XLARGE)) {
            View uploadBtn = findViewById(R.id.btn_upload);
            uploadBtn.setVisibility(View.INVISIBLE);
            View newFolderBtn = findViewById(R.id.btn_new_folder);
            newFolderBtn.setVisibility(View.INVISIBLE);
        }
    }

    public void showUploadNewFolderBtns() {
        View uploadBtn = findViewById(R.id.btn_upload);
